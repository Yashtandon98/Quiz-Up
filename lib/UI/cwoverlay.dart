...
class CWOverlay extends StatefulWidget {

  final bool _isCorrect;
  VoidCallback _onTap;

  CWOverlay(this._isCorrect, this._onTap);

  @override
  State createState() => new CWOverlayState();
}

class CWOverlayState extends State<CWOverlay> with SingleTickerProviderStateMixin {
